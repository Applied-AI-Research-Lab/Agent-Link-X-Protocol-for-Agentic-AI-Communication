...
def generate_final_report(results):
    ...
    print("\n2. LaTeX tables are ready to copy into your paper:")
    ...
    print("\n4. Review the results and update your paper's Results section")
    print("\n" + "="*80)
...
def main():
    ...
    if api_key_available:
        ...
        print("\n⚠️  Skipping Experiments 1 and 2 (API key required)")
